...
.btn-primary { text-transform: uppercase; }`}</pre>
	...
	<div class="card p-6">
		...
		<div class="mb-4 p-4 rounded-lg bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700">
			<div class="flex gap-3">
				...
				<div>
					<p class="font-medium text-amber-800 dark:text-amber-200">Demo Instance Warning</p>
					<p class="text-sm text-amber-700 dark:text-amber-300 mt-1">
						This is a shared demo. <strong>Do not enter real API keys here</strong> &mdash; anyone who logs in can see and use them.
						To test AI features securely, <a href="https://github.com/jesposito/Facet" class="underline hover:no-underline" target="_blank" rel="noopener">install the real Facet</a> on your own server.
					</p>
				</div>
			</div>
		</div>
